...
const COPY = {
	en: {
		tagline:
			"An engineering-led studio building software and digital products, supporting online growth and sharing practical knowledge.",
	...
	pl: {
		tagline:
			"Studio inżynierskie tworzące oprogramowanie i produkty cyfrowe, wspierające rozwój online i dzielące się praktyczną wiedzą.",
			...
			<div className="wrap">
				<div className="foot-top">
					...
					<div className="foot-col">
						...
						<ul>
							<li>
								<Link href={routeFor("services", locale)}>{t.services}</Link>
							</li>

							<li>
								<Link href={routeFor("work", locale)}>{t.work}</Link>
							</li>

							<li>
								<Link href={routeFor("products", locale)}>{t.products}</Link>
							</li>
						</ul>
					</div>
					...
					<div className="foot-col">
						...
						<ul>
							<li>
								<Link href={routeFor("growth", locale)}>{t.growth}</Link>
							</li>

							<li>
								<Link href={routeFor("mentoring", locale)}>{t.mentoring}</Link>
							</li>

							<li>
								<Link href={routeFor("insights", locale)}>{t.insights}</Link>
							</li>
						</ul>
					</div>
