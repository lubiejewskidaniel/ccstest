...
const COPY = {
  en: {
    ...
    projects: [
      {
        name: "TakBlisko",
        desc: "Location-based platform connecting people with places and experiences.",
        tags: ["Next.js", "PostgreSQL", "Maps API"],
      },
      {
        name: "PLMS",
        desc: "Powerful learning management system for modern education.",
        tags: ["Next.js", "Supabase", "Tailwind CSS"],
      },
      {
        name: "Dual-Layer Vault",
        desc: "Secure encrypted storage with advanced access control.",
  ...
  pl: {
    ...
    projects: [
      {
        name: "TakBlisko",
        desc: "Platforma oparta na lokalizacji, łącząca ludzi z miejscami i wydarzeniami.",
        tags: ["Next.js", "PostgreSQL", "Maps API"],
      },
      {
        name: "PLMS",
        desc: "Zaawansowany system LMS dla nowoczesnej edukacji.",
        tags: ["Next.js", "Supabase", "Tailwind CSS"],
      },
      {
        name: "Dual-Layer Vault",
        desc: "Bezpieczne, szyfrowane przechowywanie danych z zaawansowaną kontrolą dostępu.",
        tags: ["Next.js", "Encryption", "Supabase"],
      },
    ],
  },
...
export function TakBliskoArt() {
  return (
    <svg viewBox="0 0 400 220" width="100%" height="100%" preserveAspectRatio="xMidYMid slice" aria-hidden="true">
      ...
      <path d="M20 190 C90 120 140 150 200 90 C250 45 300 70 380 20" fill="none" stroke="#3b82f6" strokeWidth="2" opacity=".55" />
...
export function VaultArt() {
  return (
    <svg viewBox="0 0 400 220" width="100%" height="100%" preserveAspectRatio="xMidYMid slice" aria-hidden="true">
      ...
      <rect x="150" y="80" width="100" height="70" rx="10" fill="#0d1526" stroke="#3b82f6" strokeWidth="1.4" />
      <path d="M170 100v-8a30 30 0 0 1 60 0v8" fill="none" stroke="#7fd9ff" strokeWidth="4" strokeLinecap="round" />
      <rect x="182" y="108" width="36" height="26" rx="4" fill="#3b82f6" opacity=".85" />
      <circle cx="200" cy="121" r="4" fill="#08101f" />
    </svg>
  );
}

const ARTWORK = [TakBliskoArt, PlmsArt, VaultArt];
      ...
      <div className="wrap">
        ...
        <div className="work-grid reveal-stagger">
          {t.projects.map((project, i) => {
            const Art = ARTWORK[i]!;
            return (
              <Link href={routeFor("work", locale)} className="work-card card" key={project.name}>
