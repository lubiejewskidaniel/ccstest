...
type Item = { key: string; icon: ReactNode; title: { en: string; pl: string }; desc: { en: string; pl: string }; badge?: boolean };

// `key` is the stable service slug used as the `service` value in
// `service_cta_click` events (brief §5) - kept in sync with the matching
...
const ITEMS: Item[] = [
  {
    ...
    desc: { en: "Scalable web & cloud applications.", pl: "Skalowalne aplikacje webowe i chmurowe." },
  },
  {
    ...
    desc: { en: "MVPs, SaaS and digital products.", pl: "MVP, SaaS i produkty cyfrowe." },
  },
  {
    ...
    desc: { en: "Architecture, audits and guidance.", pl: "Architektura, audyty i doradztwo." },
  },
  {
    key: "web-digital",
    icon: (
    ...
    desc: { en: "Modern websites, landing pages and platforms.", pl: "Nowoczesne strony, landing page'e i platformy." },
  },
  {
    ...
    desc: { en: "SEO, social media, content & growth strategies.", pl: "SEO, social media, treści i strategie rozwoju." },
    badge: true,
  },
  {
    key: "mentoring",
    ...
    desc: { en: "Programming, engineering & career growth.", pl: "Programowanie, inżynieria i rozwój kariery." },
  },
];

const COPY = {
  en: { eyebrow: "What we do", title: "From idea to impact.", viewAll: "View all services", learnMore: "Learn more" },
  pl: { eyebrow: "Co robimy", title: "Od pomysłu do efektu.", viewAll: "Zobacz wszystkie usługi", learnMore: "Dowiedz się więcej" },
};
