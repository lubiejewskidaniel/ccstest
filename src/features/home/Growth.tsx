...
const ITEMS = [
  {
    ...
    desc: { en: "Improve visibility and rank higher.", pl: "Zwiększ widoczność i pozycję w wynikach." },
  },
  {
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
    ...
    desc: { en: "We create, publish and manage your content.", pl: "Tworzymy, publikujemy i zarządzamy treścią." },
  },
  {
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
    ...
    desc: { en: "Posts, graphics, Reels, videos & more.", pl: "Posty, grafiki, Reelsy, wideo i więcej." },
  },
  {
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
    ...
    desc: { en: "Data-driven strategies for real results.", pl: "Strategie oparte na danych, dające realny efekt." },
  },
  {
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
    ...
    desc: { en: "Clear reports that show what works.", pl: "Czytelne raporty pokazujące, co działa." },
  },
  {
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
    ...
    desc: { en: "Campaigns that bring quality leads.", pl: "Kampanie, które przynoszą wartościowe leady." },
  },
];

const COPY = {
  en: { eyebrow: "Digital growth", title: "We help your business grow online.", viewAll: "Explore growth services" },
  pl: { eyebrow: "Digital growth", title: "Pomagamy Twojej firmie rosnąć online.", viewAll: "Poznaj usługi growth" },
};
