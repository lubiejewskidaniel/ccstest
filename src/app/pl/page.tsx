...
export const metadata = buildPageMetadata({ routeKey: "home", locale: "pl", title, description });

export default function HomePagePl() {
  return (
    <>
      <PageStructuredData routeKey="home" locale="pl" title={title} description={description} />
      <Home locale="pl" />
    </>
  );
}
